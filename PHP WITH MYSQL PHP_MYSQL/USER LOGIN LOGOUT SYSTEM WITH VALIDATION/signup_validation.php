...
#using select query
$select_query="select * from student_data where email='$email' && password='$password'";
//query fire
...
if ($numofrows==1) {
	...
	//insert query
	$insertquery="insert into student_data(name,email,password,number)values('$name','$email','$password','$number')";
	//query fire
