...
<html lang="en">
  ...
  <div class="form-group">
    ...
    <input type="number"  name="mobile" class="form-control" id="exampleInputmobile" placeholder="mobile number" required="mobile number">
  </div>
  <button type="submit" name="submit" class="btn btn-danger" oneclick = "send_otp()" >Login</button>
</form>
      </div>
    </div>
