        ...
        if ($password===$conform_password) {
            # code...
             ...
             //check data inserted or not
                 if ($check) {
                 # code...
                //send mail for true user validation
                $to_mail=$email; #this is a receiver mail from user input
                // what is the purpose of mail
                $subject="simple email text validation ,activition via php";
                //description of php
                $body="hiii, $name please click here to activate your account-  http://localhost:8090/User%20Account%20Activation%20by%20Email%20Verification%20Link%20with%20Login%20&%20Logout%20Page/activate.php?token=$token";
                //this is a mail sender email
                $email_sender= "from: sj2585097@gmail.com";
                //check email send or not
                if (mail($to_mail, $subject, $body, $email_sender)) {
                  # code...
                  $_SESSION['message']=' go to your gmail account check mail to activate your account';
