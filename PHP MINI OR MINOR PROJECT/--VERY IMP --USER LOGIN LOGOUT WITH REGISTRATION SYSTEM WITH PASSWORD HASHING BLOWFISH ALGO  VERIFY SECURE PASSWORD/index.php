...
if (isset($_POST['submit'])) {
	...
	$email_validation="select * from information where email='$email'";
	//query fire
	...
	if ($countrow>0) {
        ...
        if ($password===$conform_password) {
            # code...
		        //insrt data
		         $insert_query="insert into information(name,email,number,password,conform_password)values('$name','$email','$number',
             '$secure_password','$secure_conform_password')";
		         //query fire
