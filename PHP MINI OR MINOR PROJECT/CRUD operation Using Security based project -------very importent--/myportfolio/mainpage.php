    ...
    <!--heqader part start-->
      <header class="container-fluid">
        <div class=" bg-primary text-center">
          ...
          <a href="../update data/update_data.php?user=<?php echo $_SESSION['user'];?>" class="text-white" style="font-size: 20px; font-weight: bold;"><i class="fas fa-user-tie"></i> <?php echo $_SESSION['user'];?></a>
         </a>
